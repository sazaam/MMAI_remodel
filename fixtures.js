        ...
        "whys":[
            {
                "name":"token_rights",
                "desc":{
                    "title":"Access rights in the form of tokens",
                    "content":"By creating access to some cryptocurrencies in the form of tokens, cryptocurrencies generated by tokens are protected even if their private keys are exposed."
                }
            },
            {
                "name":"offline_transactions",
                "desc":{
                    "title":"Offline Transactions Available",
                    "content":"The generated tokens can be exchanged for off-chain even when there is no Internet connection, so transactions can be made even when the Internet connection is unstable."
                }
            },
            {
                "name":"security",
                "desc":{
                    ...
                    "content":"It generates tokens using hash functions, validates the tokens with hash values, and ensures that only those with real cryptocurrency exchange rights of the tokens can exchange them."
                }
            },
            {
                "name":"no_device",
                "desc":{
                    "title":"No Device Required",
                    "content":"The service can be used in the form of a program without a separate device, making it convenient to manage multiple accounts at no additional cost."
                }
            },
            {
                "name":"swap",
                "desc":{
                    "title":"SWAP Features",
                    "content":"You can access smart contracts on decentralized exchange (DEX) pools such as UniSwap and PancakeSwap to exchange cryptocurrencies, and track the progress and details of transactions through transaction hash (TxHash)."
                }
            },
            {
                "name":"property_rights",
                "desc":{
                    "title":"Transfer of property rights",
                    "content":"By sending tokens offline, you can eliminate the need for an internet connection, speed up transactions, and reduce cryptocurrency exchange costs. To ensure that recipients have full control over the tokens, 3-step handshake technology is used to accurately convey token information."
                }
            }
        ]
    }`
