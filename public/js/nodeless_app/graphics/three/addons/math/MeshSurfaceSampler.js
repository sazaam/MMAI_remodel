...
THREE.MeshSurfaceSampler = function ( mesh ) {
...
THREE.MeshSurfaceSampler.prototype = {
	...
	sample:function( targetPosition, targetNormal, targetColor, targetUV ) {

		const faceIndex = this.sampleFaceIndex();
		return this.sampleFace( faceIndex, targetPosition, targetNormal, targetColor, targetUV );

	},
	sampleFaceIndex:function() {
	...
	sampleFace:function( faceIndex, targetPosition, targetNormal, targetColor, targetUV ) {
